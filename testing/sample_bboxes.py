...
from yolo.utils.bounding_box_utils import transform_bbox  # Not used anymore but kept in case needed later

# Class names (replace or expand if needed)
class_list = [
...
def load_and_draw_images(
    base_path="data/carparts-bb", 
    num_images=5, 
    label_format="xyxy"
):
    ...
    for img_path in sampled_images:
        ...
        for line in lines:
            ...
            class_id = parts[0].unsqueeze(0)
            bbox = parts[1:]

            # Assume bbox is in normalized xyxy format
